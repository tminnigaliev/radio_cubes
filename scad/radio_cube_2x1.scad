...
module radio_cube_2x1(width, height, thickness)
{
    ...
    difference()
    {
        ...
        union()
        {
            ...
            translate([3*width2/2+1,2.0,8])rotate([90,0,0])cylinder(r=14.5/2, h=2.6);
            translate([3*width2/2+1,thickness+1,8])rotate([90,0,0])cylinder(r=14.5/2, h=1);
            ...
            translate([thickness+1,width2/2,8])rotate([0,-90,0])cylinder(r=14.5/2, h=1);
            translate([-0.2,width2/2-4,5.8])cube([20,8,15]);
            translate([2.0,3*width2/2+1,8])rotate([0,-90,0])cylinder(r=14.5/2, h=2.6);
            translate([thickness+1,3*width2/2+1,8])rotate([0,-90,0])cylinder(r=14.5/2, h=1);
            translate([-0.2,3*width2/2-3,5.8])cube([20,8,15]);
            
            // x
            translate([width+0.6,width2/2,8])rotate([0,-90,0])cylinder(r=14.5/2, h=2.6);
            translate([width-thickness,width2/2,8])rotate([0,-90,0])cylinder(r=14.5/2, h=1);
            translate([width-10,width2/2-4,5.8])cube([20,8,15]);

            translate([width+0.6,3*width2/2+1,8])rotate([0,-90,0])cylinder(r=14.5/2, h=2.6);
            translate([width-thickness,3*width2/2+1,8])rotate([0,-90,0])cylinder(r=14.5/2, h=1);
            translate([width-10,3*width2/2-3,5.8])cube([20,8,15]);

            //bottom
            translate([width2/2,width2/2,-0.1]) cylinder(r=15.3/2, h=3.6);        
            translate([width2/2-2.25,width2/2-4,0])cube([4.5,8,15]);
            translate([3*width2/2+1,width2/2,-0.1]) cylinder(r=15.3/2, h=3.6);        
            translate([3*width2/2-2.25+1,width2/2-4,0])cube([4.5,8,15]);

            translate([width2/2,3*width2/2+1,-0.1]) cylinder(r=15.3/2, h=3.6);        
            translate([width2/2-2.25,3*width2/2-4+1,0])cube([4.5,8,15]);
            translate([3*width2/2+1,3*width2/2+1,-0.1]) cylinder(r=15.3/2, h=3.6);        
            translate([3*width2/2-2.25+1,3*width2/2-4+1,0])cube([4.5,8,15]);
